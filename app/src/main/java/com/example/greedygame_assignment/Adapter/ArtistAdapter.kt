...
import com.example.greedygame_assignment.Model.ArtistDetail
...
class ArtistAdapter: RecyclerView.Adapter<ArtistAdapter.MyViewHolder>() {
    ...
    private var listData:MutableList<ArtistDetail>? = null
    lateinit var context:Context

    fun setListData(context: Context, listData: MutableList<ArtistDetail>){
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        holder.title_name.text =listData?.get(position)!!.artistName
        ...
        var name:String = listData?.get(position)!!.artistName
